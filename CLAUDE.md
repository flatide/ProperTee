...
- Built-in functions: `PRINT SLEEP SUM MAX MIN ABS FLOOR CEIL ROUND RANDOM LEN TO_NUMBER TO_STRING PUSH POP CONCAT SLICE CHARS SPLIT JOIN SUBSTRING UPPERCASE LOWERCASE TRIM HAS_KEY KEYS MILTIME DATE TIME`
