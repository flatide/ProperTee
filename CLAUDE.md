...
All three repos share the same ANTLR4 grammar (`grammar/ProperTee.g4`) — keep them in sync. Both implementations pass the same 46-test suite.
...
- `parallelStmt` → the `multi ... end` block
