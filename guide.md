...
ProperTee는 코드 문서화를 위해 두 가지 형태의 주석을 지원합니다.

### 7.1 한 줄 주석

`//`로 시작하는 한 줄 주석입니다. 라인의 끝까지 주석으로 처리됩니다.

```propertee
// 이것은 한 줄 주석입니다
x = 10

y = 20  // 코드 뒤에도 주석을 작성할 수 있습니다
...
`/*`로 시작하고 `*/`로 끝나는 블럭 주석입니다. 여러 줄에 걸쳐 작성할 수 있습니다.
 ...
 * 자주 사용됩니다
 */
function_result = PROCESS_DATA(data)
```
...
```propertee
/* 외부 주석 /* 내부 주석? */ 여기는 주석이 아닙니다! */  // ⚠️ 첫 */에서 닫힘
```
